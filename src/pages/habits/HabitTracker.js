...
const HabitTracker = () => {
  ...
  const enterHabit = async (e) => {
    ...
    await axios.post("https://moodpalette-api.onrender.com/api/users/addHabit", addHabit); // call login api call, asccessing the req.body.habit in users.j

    const res = await axios.get(`https://moodpalette-api.onrender.com/api/users/${user._id}`);
  ...
  const deleteHabit = async (e, habitD) => {
    ...
    const test = await axios.post("https://moodpalette-api.onrender.com/api/users/deleteHabit", deleteHabit);
    console.log("test", test);
    const test1 = await axios.post("https://moodpalette-api.onrender.com/api/day/deleteHabit", deleteDayHabit);
  ...
  const updateHabitPopup = async (e) => {
    ...
    await axios.post("https://moodpalette-api.onrender.com/api/users/deleteHabit", deleteHabit);
    ...
    await axios.post("https://moodpalette-api.onrender.com/api/users/addHabit", addHabit); // call login api call, asccessing the req.body.habit in users.
